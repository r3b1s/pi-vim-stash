# Vestigial Hermes MemoryProvider plugin. Retained for upstream sync compatibility. Not used by Pi extension.
...
try:
    ...
    class MemoryProvider(ABC):
        """Stub for testing when the Hermes agent module is unavailable."""
        @abstractmethod
...
try:
    ...
    def tool_error(msg): return f'{"error"}: {msg}'
