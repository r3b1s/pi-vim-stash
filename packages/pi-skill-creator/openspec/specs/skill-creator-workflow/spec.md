...
Define the `/sc` extension workflow, visible workflow state, run lifecycle, side-thread tracking, durable run storage, skill instruction activation, and safe artifact-writing boundaries for the Pi skill-creator extension.
