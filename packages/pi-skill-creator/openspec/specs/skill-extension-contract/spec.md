...
Define the contract between the bundled skill, `/sc`, and `sc_*` tools, including tool responsibilities, structured tool results, state mutation rules, and extension-aware skill guidance for the Pi skill-creator extension.
